...
<body>
	...
	<div id="container">
		<form action="" method="post" id="form1" enctype="multipart/form-data" novalidate>
			...
			<section id="basic_sec" class="section">					
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['name']) && $data['status']=='error'){
				...
				<div class="form-input cstm">
					...
					<input type="radio" name="gender" value="" hidden="" checked id="err_gender">						
					<?php
					//  if(isset($data['message']['gender']) && $data['status']=='error'){
					// echo '<p class="error">'.$data['message']['gender'].'</p>';}
					?>
				</div>

				<div class="form-input">
					<input type="file" class="cstm" name="profile_pic" id="my_file_field" >
					<?php 
					// if (isset($_POST['submit'])){imgUpload();}						
				...
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['username']) && $data['status']=='error'){
				...
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['email']) && $data['status']=='error'){
					// echo '<p class="error">'.$data['message']['email'].'</p>';}
					?>
				</div>

				<div class="form-input">
					<input class="inp" type="password" name="password" placeholder="Password*" id="password" minlength="8"> 
					<?php 
					// if(isset($data['message']['password']) && $data['status']=='error'){
					// echo '<p class="error">'.$data['message']['password'].'</p>';}
					?>
				</div>

				<div class="form-input">
					<input class="inp" type="password" name="confirm_password" placeholder="confirm Password*" id="confirm_password" minlength="8"> 
					<?php 
					// if(isset($data['message']['confirm_password']) && $data['status']=='error'){
			...
			<section id="contact_sec" class="section">
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['mobile_number']) && $data['status']=='error'){
				...
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['state']) && $data['status']=='error'){
				...
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['city']) && $data['status']=='error'){
				...
				<div class="form-input">
					...
					<?php 
					// if(isset($data['message']['address']) && $data['status']=='error'){
			...
			<section id="interest_sec" class="section">
				<div class="form-input">
					<select name="course" class="inp" id="course">
					...
					<?php 
					// if(isset($data['message']['course']) && $data['status']=='error'){
				...
				<div class="form-input cstm">
					...
					<?php 
					// if(isset($data['message']['hobby']) && $data['status']=='error'){
					// echo '<p class="error">'.$data['message']['hobby'].'</p>';}
					?>
				</div>

				<button type="submit" name="Submit" class="inp" id="submit" value="submit">submit</button>
			</section>
		</form>		
	</div>
</body>	
